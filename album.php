...
<div id="albumContainer">
	<div class='artistTopViewContainer' >
		...
		<div id="rightContainer">
			...
			<div class="by"> 
				by <span role="link" tabindex="0" onclick="openPage('artist.php?id=<?php echo $artistId; ?>')" >  <b> <?php echo $artist->getName(); ?> </b> </span>
			</div>
			<div id="artistInfo" >
				
				<?php echo $album->getNumberOfSongs();?> songs • <?php echo $album->getGenreName();?> • <?php echo $album->getYear(); ?> 
			</div>
			<br> <br> <br>
...
<span id="copyright"> © <?php echo $album->getYear();?> licensed to <?php echo $artist->getName(); ?></span>

...
echo "<div class='albumTopViewContainer'>
	...
	<div id="rightContainer">
		...
		<div >
			<b> <?php echo $artist->getCountry(); ?> </b>
		</div>
		<div id="artistInfo" >
...
<div class="InYourMusic">All albums &nbsp; &nbsp; &nbsp; 
	<div class='headerControls'>
		<span onclick='playIconShortcut("artist", <?php echo $artistId ?>)'> <img src="assets/images/icons/play (2).png" alt="Play" title= 'Play' >  &nbsp; Play All</span>
		<span onclick='makeShuffle(tempPlaylist)'> <img src="assets/images/icons/shuffle (2).png" alt="Shuffle" title= 'Shuffle' >  &nbsp; Shuffle </span>
	</div>
</div>	
...
<div class="gridViewContainer">
 ...
 <div class="tracklistContainer songsView">
	 <div class="InYourMusic">Biggest hits &nbsp; 
		<img onclick='playFirstSong()' role='link' class='zoomless' src="assets/images/icons/play-next.png" title="Play" alt='play'> 
	</div>

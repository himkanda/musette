	...
	<div class='albumTopViewContainer borderBottom' style="background: url(assets/images/artistbg.jpg)">
		...
		<div id="rightContainer">
			...
			<section class="accountSettings">
				<span>Email : <b> <?php echo $userLoggedIn->getEmail(); ?> </b> </span>
				<span >Username : <b> <?php echo $userLoggedIn->getUsername(); ?> </b> </span>
				<span class='permLink2' onclick="openPage('updateDetails.php')">Update Details</span>
				<img src="assets/images/icons/full-screen.png" title="Full Screen toggle"  onclick="toggleFullScreen()" class="fullScreen zoom">

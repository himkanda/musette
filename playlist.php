		...
		<div id='playlistContainer'>
			<div class='entityInfo'>
				...
				<div class='rightSection'>
					...
					<p>
						<?php echo $playlist->getNumberOfSongs(); ?> songs • <span id='getTotalTimeNP'></span>
					</p>
					<p> created on
					...
					<div class='headerControls'>
						...
						<span onclick='renamePlaylist( <?php echo $playlistId; ?> )'> <img src="assets/images/icons/rename.png"
								alt="Rename" title='Rename'> &nbsp; Rename </span>
						<span onclick='deletePlaylist( <?php echo $playlistId; ?> )'> <img src="assets/images/icons/delete.png"
								alt="Delete" title='Delete Playlist'> &nbsp; Delete </span>
					</div>
				</div>
							...
							<div class='entityInfo'>
								...
								?>
									...
									<div class='headerControls'>
										<span onclick='playFirstSong()'> <img src="assets/images/icons/play (2).png" alt="Play"
												title='Play All'> &nbsp; Play All </span>
										<span onclick='makeShuffle(tempPlaylist)'> <img src="assets/images/icons/shuffle (2).png"
												alt="Shuffle" title='Shuffle All'> &nbsp; Shuffle </span>
										<span class='savePlaylistButton'
											onclick='savePlaylistToMyLibrary(<?php echo $playlistId; ?>)'>

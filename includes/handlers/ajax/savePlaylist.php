...
if(isset($_POST['array']) && isset($_POST['username']) && isset($_POST['name'])){
    ...
    $query= mysqli_query($con, "INSERT into playlists values ('', '$name', '$username', '$date', '1', NULL, NULL)");
    ...
    foreach ($cp as $data){
        ...
        $query2= mysqli_query($con, "INSERT into playlistSongs values ('', '$data', '$playlistId','$order' )");
    }

	...
	<nav class="navBar ">
		...
		<div id='topNavBar'>
			...
			<div class="group middleNavBar">
				...
				<div class="navItem" >
					<span role="link" tabindex="0" onclick="openPage('nowPlaying.php')" class="navItemLink ">Now Playing</span>
				</div>
			...
			<div class="group middleNavBar">
				...
				<div class="navItem">
					<span role='link' tabindex='0' onclick="openPage('yourArtists.php')" class="navItemLink ">Artists</span>
				</div>

				<div class="navItem">
					<span role="link" tabindex="0" onclick="openPage('yourAlbums.php')" class="navItemLink ">Albums</span>
				</div>
		...
		<div class=" bottomNavBar">
			<div class="navItemSettings navItem" >
				<span class="grey "><?php echo $userLoggedIn->getName(); ?></span>
				&nbsp;
				&nbsp;
				&nbsp;
				&nbsp;

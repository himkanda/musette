...
<div class="swiper-container">
    <div class="swiper-wrapper">
        <div class="swiper-slide" style="background-image:url(assets/images/slideshow/two.jpg)" onclick="openPage('album.php?id=12')"></div>
        <div class="swiper-slide" style="background-image:url(assets/images/slideshow/three.jpg)" onclick="openPage('artist.php?id=6')"></div>
		<div class="swiper-slide" style="background-image:url(assets/images/slideshow/four.jpg)" onclick="openPage('artist.php?id=8')"></div>
		<div class="swiper-slide" style="background-image:url(assets/images/slideshow/one.jpg)" onclick="openPage('playlist.php?id=33')"></div>
        <div class="swiper-slide" style="background-image:url(assets/images/slideshow/six.jpg)" onclick="openPage('artist.php?id=10')"></div>
        <div class="swiper-slide" style="background-image:url(assets/images/slideshow/five.jpg)" onclick="openPage('album.php?id=9')"></div>
    </div>
    <!-- Add Pagination -->
...
<div class="gridViewContainer">
	...
	<?php
		$albumQuery = mysqli_query($con, "SELECT * FROM Slotify.albums AS t1 LEFT JOIN userdata.$username AS t2 ON t1.id = t2.album WHERE t2.album is null ORDER BY RAND() LIMIT 5 ");
...
<span class="mainContentInfo"> 🎶 These are just some of the playlists created by our users that we thought you would like. </span>
